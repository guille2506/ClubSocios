...
// ================== 💳 Métodos de pago ==================
$sql = "SELECT id, nombre FROM metodos_de_pago WHERE admin_id = ?";
...
<!-- Mirrored from techzaa.in/venton/invoice-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Jun 2025 20:43:25 GMT -->

<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
     <title>Gimansio</title>
                    ...
                    <div class="row">
                         <div class="col-12">
                              <div class="page-title-box">
                                   <h4 class="mb-0 fw-semibold">Invoices List</h4>
                              ...
                              <div class="card">
                                   <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                             <div>
                                                  <h4 class="card-title mb-2 d-flex align-items-center gap-2">Total de miembros</h4>
                         ...
                         <div class="col-lg-3">
                              <div class="card">
                                   <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                             <div>
                                                  <h4 class="card-title mb-2 d-flex align-items-center gap-2">Miembros al dia</h4>
                                                  <p class="text-muted fw-medium fs-22 mb-0">22</p>
                                             </div>
                                             <div>
                                                  <a href="./paginas_situacion/Miembros-Al-Dia.php">
                                                       <div class="avatar-md bg-success bg-opacity-10 rounded">
                                                            <iconify-icon icon="solar:bill-check-bold-duotone" class="fs-32 text-success avatar-title"></iconify-icon>
                                                       </div>
                                                  </a>
                                             </div>
                                        </div>
                         ...
                         <div class="col-lg-3">
                              <div class="card">
                                   <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                             <div>
                                                  <h4 class="card-title mb-2 d-flex align-items-center gap-2">Deben cuota</h4>
                                                  <p class="text-muted fw-medium fs-22 mb-0">22</p>
                                             </div>
                                             <div>
                                                  <a href="./paginas_situacion/Deben-cuota.php">
                         ...
                         <div class="col-lg-3">
                              <div class="card">
                                   <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                             <div>
                                                  <h4 class="card-title mb-2 d-flex align-items-center gap-2">No pago cuota</h4>
                                                  <p class="text-muted fw-medium fs-22 mb-0">22</p>
                                             </div>
                                             <div>
                                                  <a href="./paginas_situacion/No-Pago-Cuota.php">
                                        ...
                                        <div class="table-responsive">
                                             <table class="table align-middle mb-0 table-hover table-centered">
                                                  ...
                                                  <tbody id="tablaMiembros">
                                                       <tr>
                                                            <td colspan="8" class="text-center">Cargando miembros...</td>
                                                       </tr>
                                                  </tbody>
                                             </table>
                                        </div>
                    ...
                    <div class="row">
                         <div class="col-12 text-center">
                              <script>
                                   ...
                                   href="https://guillermoillanes.com/" class="fw-bold footer-text" target="_blank">Moto</a>
                         </div>
                    </div>
               </div>
          </footer>
